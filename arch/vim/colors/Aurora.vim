" Aurora -  Full Colour and 256 Colour
" http://chriskempson.com

" Default GUI Colours
let s:foreground = "C7C7C7"
let s:background = "1d1f8f"
let s:selection = "373b41"
let s:line = "282a2e"
let s:comment = "969896"
let s:window = "4d5050"

let s:dark_slate_blue = "5f5f87"
let s:golden = "FFD557"
let s:light= "F0D2A8"
let s:cyan = "9ccdff"
let s:blue = "005fff"
let s:horizon = "afd7ff"
let s:red = "cc6666"
let s:green = "b5bd68"
let s:aqua = "8abeb7"
let s:orange = "de935f"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("String", s:golden, "", "")
	call <SID>X("Special", s:foreground, "", "")
	call <SID>X("PreProc", s:dark_slate_blue, "", "")
	call <SID>X("Operator", s:aqua, "", "none")
	call <SID>X("Type", s:white, "", "bold")
	call <SID>X("Define", s:dark_slate_blue, "", "none")
	call <SID>X("Include", s:dark_slate_blue, "", "")
	...
	" C Highlighting
	call <SID>X("cType", s:white, "", "bold")
	call <SID>X("cStorageClass", s:purple, "", "")
	call <SID>X("cConditional", s:blue, "", "")
	call <SID>X("cRepeat", s:blue, "", "")

    " C EasyTags Plugin
    call <SID>X("cTypeTag", s:white, "", "bold")
    call <SID>X("cEnumTag", "f06547", "", "")
    call <SID>X("cPreProcTag", "FFAB90", "", "")
    call <SID>X("cFunctionTag", s:red, "", "")
    call <SID>X("cMemberTag", "00A6FF", "", "")



    " CSharp EasyTags Plugin
    call <SID>X("csClassOrStructureTag", "00FFFF", "", "")
    call <SID>X("csMethodTag", "0FFAEE", "", "")
